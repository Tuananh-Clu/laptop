    ...
    <div className="text-center mt-20 px-10">
      ...
      <div className="flex items-center justify-center ">
        ...
        <div className="overflow-hidden  w-[2000px] ">
          <div
            className="flex  md:gap-10 transition-transform duration-300 ease-in-out md:px-10"
            style={{ transform: `translateX(${tx}px)` }}
          >
            {dsa.map((item, index) => (
              <div
                key={index}
                className=" min-w-[250px] md:min-w-[300px] bg-gray-100 rounded-xl p-4 shadow-md"
              >
                <img
                  src={item.image}
                  alt={`img-${index}`}
